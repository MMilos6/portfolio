...
import {
    FaCogs, FaCss3Alt, FaFigma, FaGitAlt, FaNodeJs, FaProjectDiagram, FaReact, FaShoppingCart,
    FaTachometerAlt
} from 'react-icons/fa';

import styles from './style.module.css';

// Define the type for each technology section
